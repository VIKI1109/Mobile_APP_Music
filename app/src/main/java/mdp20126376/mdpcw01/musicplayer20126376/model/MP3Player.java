...
public class MP3Player {
    ...
    protected String filePath; //the path of the song in the song list
    protected Uri uri; // the uri of the song from another application
    ...
    public void load(String filePath) {
        ...
        mediaPlayer.start();
        mediaPlayer.setOnCompletionListener(mediaPlayer -> load(filePath));
    }


    /**
     * load the music by URI
     * @param uri the uri of the song from another application
     */
    public void  load_out_music(Uri uri) {
        this.uri = uri;
        mediaPlayer = new MediaPlayer();
        mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
    ...
    public void seekTo(int seekBar_progress){
        if(mediaPlayer!=null){
            mediaPlayer.seekTo(seekBar_progress);
            mediaPlayer.start();
           }
